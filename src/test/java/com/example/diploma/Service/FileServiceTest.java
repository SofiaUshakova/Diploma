...
class FileServiceTest {
    ...
    void deleteFileInputException() {
        ...
        assertThrows(InputException.class, () -> fileService.deleteFile(BEARER_TOKEN, FILENAME_1));
    }
    ...
    void downloadFileInputDataException() {
        Mockito.when(storageFileRepository.findByFileAndUser(FILENAME_1, USER_1)).thenReturn(STORAGE_FILE_1);
        assertThrows(InputException.class, () -> fileService.downloadFile(BEARER_TOKEN, FILENAME_2));
    }
    ...
    void editFileNameUnauthorized() {
        assertThrows(UnauthorizedException.class, () -> fileService.editFileName(TOKEN_1, FILENAME_1, EDIT_FILE_NAME_RQ));
    }
