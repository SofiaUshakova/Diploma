...
public class Testdata {
    ...
    public static final StorageFile STORAGE_FILE_1 = new StorageFile(USER_1, FILENAME_1, SIZE_1, LocalDateTime.now(), FILE_CONTENT_1);
    ...
    public static final StorageFile STORAGE_FILE_2 = new StorageFile(USER_2, FILENAME_2, SIZE_2, LocalDateTime.now(), FILE_CONTENT_2);
    ...
    public static final StorageFile FOR_RENAME_STORAGE_FILE = new StorageFile(USER_1, FOR_RENAME_FILENAME, FOR_RENAME_SIZE, LocalDateTime.now(), FOR_RENAME_FILE_CONTENT);

    public static final String NEW_FILENAME = "NewFilename";
    public static final FileNameEditRequest EDIT_FILE_NAME_RQ = new FileNameEditRequest(NEW_FILENAME);
